...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.allowDrop = function (data) {
        data.preventDefault();
    };
    ListComponent.prototype.onFileSelected = function (event) {
        var _this = this;
        ...
        fileReader.onload = function (x) {
            ...
            pdfjs_dist_build_pdf__WEBPACK_IMPORTED_MODULE_2__["getDocument"](_this.fileContent).then(function (pdf) {
